package com.cg.SampleApplication.general.common.api.exception;

import com.cg.SampleApplication.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link com.cg.SampleApplication.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the SampleApplicationEntity entity.
