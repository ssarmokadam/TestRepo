...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cg.SampleApplication.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cg.SampleApplication.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
