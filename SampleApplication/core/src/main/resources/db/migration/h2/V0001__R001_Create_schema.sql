...
--ALTER TABLE OFFERTA
--ADD CONSTRAINT FK_Intervista FOREIGN KEY(idIntervista) REFERENCES INTERVISTA(idIntervista) NOCHECK,
--ADD CONSTRAINT FK_Preventivo FOREIGN KEY(idIntervista) REFERENCES INTERVISTA(idIntervista) NOCHECK
-- *** Staffmemeber ***
