INSERT INTO INTERVISTA(id, modificationCounter,idIntervista,nome, cognome,datanascita,ndg,codabi,cellulare,email,indirizzo) values (1,1,1,'nir','bor','2016-12-24','ndg2',01025,8888888888,'nir.bor@cg.com','mumbai');

INSERT INTO OFFERTA(id, modificationCounter,IDOFFERTA,IDINTERVISTA,NDG) values (1,1,1,1,'ndg1');
INSERT INTO OFFERTA(id, modificationCounter,IDOFFERTA,IDINTERVISTA,NDG) values (2,1,2,1,'ndg2');

INSERT INTO PREVENTIVO(id, modificationCounter,idPreventivo,IDOFFERTA,codProdotto,importoRichiesto,durataMesi) values(1,0,1,1,01,2255,12);
INSERT INTO PREVENTIVO(id, modificationCounter,idPreventivo,IDOFFERTA,codProdotto,importoRichiesto,durataMesi) values(2,0,2,1,02,2266,12);
INSERT INTO PREVENTIVO(id, modificationCounter,idPreventivo,IDOFFERTA,codProdotto,importoRichiesto,durataMesi) values(3,0,3,1,03,2277,12);
