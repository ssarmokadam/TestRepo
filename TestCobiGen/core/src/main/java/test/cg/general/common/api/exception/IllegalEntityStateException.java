package test.cg.general.common.api.exception;

import test.cg.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link test.cg.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the TestCobiGenEntity entity.
