package test.cg.general.common.impl.security;
...
import test.cg.general.common.api.security.UserData;
import test.cg.general.service.impl.config.BaseWebSecurityConfig;
